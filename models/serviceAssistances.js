...
module.exports = (sequelize, DataTypes) => {
  class serviceAssistances extends Model {
    /**
     * Helper method for defining associations.
     * This method is not a part of Sequelize lifecycle.
     * The `models/index` file will call this method automatically.
     */
    static associate(serviceAssistances) {
      // define association here
    }
  }
  serviceAssistances.init(
    {
      seq: {
      ...
      assistant: {type: DataTypes.JSON, allowNull: false}, 
...

    {
      ...
      // },
      sequelize,
      modelName: "serviceAssistances",
      tableName: "SRV_RT_Service_Assistants",
      underscored: true,
      freezeTableName: true,
    }
  );
  return serviceAssistances;
};
